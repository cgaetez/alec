...
class HomeworksControllerTest < ActionController::TestCase
  ...
  test "should create homework" do
    assert_difference('Homework.count') do
      post :create, homework: { activity: @homework.activity, content: @homework.content, course_id: @homework.course_id, status: @homework.status, teacher_id: @homework.teacher_id, title: @homework.title }
    end
  ...
  test "should update homework" do
    patch :update, id: @homework, homework: { activity: @homework.activity, content: @homework.content, course_id: @homework.course_id, status: @homework.status, teacher_id: @homework.teacher_id, title: @homework.title }
    assert_redirected_to homework_path(assigns(:homework))
  end
